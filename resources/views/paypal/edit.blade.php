            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="review-content-section">
                    <div id="dropzone1" class="pro-ad">
                        <form action="{{route('PayPal.update', ['id' => $paypals->idpp])}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <input name="producto" id="producto" type="text" class="form-control" placeholder="Titulo de la imagen" value="{{$paypals->producto}}">
                                    </div>
                                    <div class="form-group">
                                        <input name="precio" id="precio" type="text" class="form-control" placeholder="Descripcion" value="{{$paypals->precio}}">
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <textarea name="descripcion" placeholder="Descripción" value="{{$paypals->descripcion}}"></textarea>
                                    <label for="file" >BUSCAR  ARCHIVO</label>
                                    <br><input type="file" name="file" class="form-control-file"  id="file">

                                    <br><img src="../../public/upload/{{$paypals->imagen}}" alt="" width="70" height="70"/>
