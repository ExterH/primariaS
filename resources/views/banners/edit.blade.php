            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="review-content-section">
                    <div id="dropzone1" class="pro-ad">
                        <form action="{{route('banners.update', ['id' => $banners->idb])}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <input name="nombre" id="nombre" type="text" class="form-control" placeholder="Titulo de la imagen" value="{{$banners->nombre}}">
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <textarea name="info" placeholder="Descripción" value="{{$banners->detalle}}"></textarea>
                                    </div>
                                    
                                    <label for="file" >BUSCAR  ARCHIVO</label>
                                    <br><input type="file" name="file" class="form-control-file"  id="file">

                                    <br><img src="../../public/upload/{{$banners->imagen}}" alt="" width="70" height="70"/>
